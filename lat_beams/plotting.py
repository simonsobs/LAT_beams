...
def plot_focal_plane(
    ...
    * R^2 histogram, "{ufm}_fp_r2.png"
    ...
    # Define plots with tuples (data, xlabel, ylabel, color_ax, c_ax_label, filename, plot_type)
    plots = [
        (
        ...
        (fp_data["R2"], "R2", "Dets (#)", None, None, f"{ufm}_fp_r2.png", "hist"),
    ]
