...
lat_params = {"az_offset":1.49788300e-08, "el_offset":-2.08882807e-01, "roll_offset":3.40844271e-02, "xi_offset":1.21677030e-01, "eta_offset":-2.08870814e-01}
lat_params = {"az_offset":4.03704816e-08, "el_offset":-1.39564042e-01, "roll_offset":-1.75482402e-01, "xi_offset":1.40683504e-01, "eta_offset":-3.15087378e-01}
def apply_pointing_model(params, az, el, roll):
    ...
    q_enc = quat.rotation_lonlat(-1*(az.copy() + params["az_offset"]), el.copy() + params["el_offset"])
    ...
    new_az, el, roll = quat.decompose_lonlat(q_enc * q_tel * q_roll)*np.array([-1, 1, 1])[..., None]
