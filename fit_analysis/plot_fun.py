...
def plot_fit_result(
    ...
    if circle_radius is not None and circle_center is not None:
        circle = plt.Circle(
            circle_center, circle_radius, color="r", fill=False, linewidth=5
        )
    ...
    ax[1][0].imshow(T, vmin=vmin, vmax=vmax * 0.05, origin="lower", cmap="viridis")
    ax[1][0].set_title("Data (5% vmax)")
    ax[1][1].imshow(fit, vmin=vmin, vmax=vmax * 0.05, origin="lower", cmap="viridis")
    ax[1][1].set_title("Fit (5% vmax)")
    ax[1][2].imshow(
        residual, vmin=vmin, vmax=vmax * 0.05, origin="lower", cmap="viridis"
    )
